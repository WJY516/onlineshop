												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<form>
															...
															<input id="text_box" name="goodsum" type="text" value="1" style="width:30px;" />
															<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" />
															<span id="Stock" class="tb-hidden">库存${tbgoodsIntro.goodsFreenum}<span class="stock"></span>件</span>
														</form>
														</dd>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="../cart/add?goodsid=${tbgoodsIntro.goodsId}&goodsnumber=1"><i> </i>加入购物车</a>
								</div>
							</li>
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li title=""">${tbgoodsIntro.goodsDiscribes}</li>
										</ul>
										<div class="clear"></div>
									</div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										...
										<c:forEach items="${goodsidlist}"   var = "list">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														<!-- 评论元数据 -->
														<a href="#link-to-user" class="am-comment-author">${list.username}</a>
														<!-- 评论者 -->
														评论于
														<time datetime="">${list.commentTime}</time>
													</div>
												</header>
