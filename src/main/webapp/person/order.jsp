...
<div class="hmtop">
			...
			<div class="am-container header">
				<ul class="message-l">
					<div class="topMessage">
						...
						<%if(session.getAttribute("username")==null){ %>
							<a href="../onlineshop/home/login.jsp" target="_top" class="h">亲，请登录</a>
							<a href="../onlineshop/home/register.jsp" target="_top">免费注册</a>
							<%} %>
						</div>
					</div>
				</ul>
				...
				<div class="nav white">
					<div class="logoBig">
						<li><img src="../onlineshop/images/logobig.png" /></li>
					</div>
										...
										<div class="order-list">
											...
											<div class="order-status0">
												<div class="order-title">
													...
													<a href="/onlineshop/order/checkordergoods?id=${orderlist.orderId}">详情</a>										
											</c:forEach>
