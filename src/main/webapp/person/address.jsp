						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form action="/onlineshop/address/insert" class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											...
											<input name="username" value="${sessionScope.username}"/>
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<input type="submit" class="am-btn am-btn-danger">保存</input>
